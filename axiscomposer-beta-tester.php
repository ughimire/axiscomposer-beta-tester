<?php
/**
 * Plugin Name: AxisComposer Beta Tester
 * Plugin URI: https://github.com/axisthemes/axiscomposer-beta-tester
 * Description: Run bleeding edge versions of AxisComposer from our Github repo.
 * Version: 1.0.0
 * Author: AxisThemes
...
if ( ! class_exists( 'AC_Beta_Tester' ) ) :
	 ...
	 */
	class AC_Beta_Tester {

		/** Github Data */
		private $config = array();

		/** @var AC_Beta_Tester The single instance of the class */
		...
		public function __construct() {
			$this->config = array(
				'plugin_file'        => 'axiscomposer/axiscomposer.php',
				'slug'               => 'axiscomposer',
				'proper_folder_name' => 'axiscomposer',
				'api_url'            => 'https://api.github.com/repos/axisthemes/axiscomposer',
				'github_url'         => 'https://github.com/axisthemes/axiscomposer',
				'requires'           => '4.2',
				'tested'             => '4.2'
			);
		...
		public function set_update_args() {
			...
			$this->config[ 'zip_url' ]      = 'https://github.com/axisthemes/axiscomposer/zipball/' . $this->config[ 'new_version' ];
		}
		...
		public function overrule_transients() {
			return ( defined( 'AC_BETA_TESTER_FORCE_UPDATE' ) && AC_BETA_TESTER_FORCE_UPDATE );
		}
		...
		public function upgrader_source_selection( $source, $remote_source, $upgrader ) {
			...
			if ( strstr( $source, '/axisthemes-axiscomposer-' ) ) {
	...
	register_activation_hook( __FILE__, array( 'AC_Beta_Tester', 'activate' ) );
